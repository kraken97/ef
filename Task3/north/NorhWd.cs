...
{
    public partial class NorhWd : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
           ...
           var initialStr=$@"Data Source={cDir}/northwind.db";
           System.Console.WriteLine(initialStr);
            optionsBuilder.UseSqlite(initialStr);
        }
